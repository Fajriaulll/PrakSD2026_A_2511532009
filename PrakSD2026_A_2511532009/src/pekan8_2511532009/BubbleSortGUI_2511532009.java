...
public class BubbleSortGUI_2511532009 extends JFrame {
    ...
    public BubbleSortGUI_2511532009() {
        ...
        //event Set Array 
        setButton_2009.addActionListener ( e -> setArrayFromInput_2009());
    ...
    private void setArrayFromInput_2009() {
        ...
        for (int k_2009 = 0; k_2009 < array_2009.length; k_2009++) {
            ...
            labelArray_2009[k_2009].setOpaque(true);
            labelArray_2009[k_2009].setBackground(Color.WHITE);
    ...
    private void performStep_2009() {
        if ( !sorting_2009 || i_2009 >= array_2009.length - 1) {
            sorting_2009 = false;
            stepButton_2009.setEnabled(false);
        ...
        labelArray_2009[j_2009].setBackground(Color.cyan);
        labelArray_2009[j_2009+1].setBackground(Color.cyan);
        if (array_2009[j_2009] > array_2009 [j_2009+1]) {
            //swap
            int temp_2009 = array_2009[j_2009];
            array_2009[j_2009] = array_2009[j_2009+1];
            array_2009[j_2009+1] = temp_2009;
            labelArray_2009[j_2009].setBackground(Color.RED);
            labelArray_2009[j_2009+1].setBackground(Color.RED);
            stepLog_2009.append("Langkah ").append(stepCount_2009).append(": Menukar elemen ke-").append(j_2009).append(" (").append(array_2009[j_2009+1])
            .append(") dengan ke-").append(j_2009+1).append(" (").append(array_2009[j_2009]).append(")\n");
        } else {
            stepLog_2009.append("Langkah ").append(stepCount_2009).append(": Tidak ada pertukaran elemen ke-").append(j_2009).append(" dan ke-").append(j_2009+1)
            .append("\n");
        }
        ...
        updateLabels_2009();
        j_2009++;
        if (j_2009 >= array_2009.length - i_2009 - 1) {
            j_2009 =0;
            i_2009++;
        }
        stepCount_2009++;
        if (i_2009 >= array_2009.length - 1) {
            sorting_2009 = false;
            stepButton_2009.setEnabled(false);
            JOptionPane.showMessageDialog(this, "Sorting selesai!");
        }
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    BubbleSortGUI_2511532009 frame = new BubbleSortGUI_2511532009();
